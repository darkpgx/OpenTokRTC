...
$("#mailButton").mouseover(function(){
  var left = $('#mailButton').offset().left - $('.arrow_box').width();
...
$("#filtersButton").mouseover(function(){
  var left = $('#filtersButton').offset().left - $('.arrow_box').width();
  $('.arrow_box').css('left', left);
  $('.arrow_box').css('display', 'block');
});
...
$("#recordButton").mouseover(function(){
  var left = $('#recordButton').offset().left - $('.arrow_box').width();
  $('.arrow_box').css('left', left);
  $('.arrow_box').css('display', 'block');
});
...
$("#roomLinkButton").mouseover(function(){
  var left = $('#roomLinkButton').offset().left - $('.arrow_box').width();
  $('.arrow_box').css('left', left);
  $('.arrow_box').css('display', 'block');
});
...
$("#chatButton").mouseover(function(){
  var left = $('#chatButton').offset().left - $('.arrow_box').width() - 15;
  $('.arrow_box').css('left', left);
  $('.arrow_box').css('display', 'block');
});
